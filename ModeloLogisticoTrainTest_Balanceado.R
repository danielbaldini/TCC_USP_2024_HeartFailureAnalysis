...
modelStepwise <- summ(model = step_modelo_logistico_binario, confint = T, digits = 4, ci.width = 0.95)

colunasModelo <- c(colnames(modelStepwise$model$model))
...
df_predito_Logistico_Binario$preditoTreinoBinario <- as.factor(if_else(df_predito_Logistico_Binario$preditoTreino >0.65,1,0))
...
#cut_log_teste_bal <- testarCutoff(df_predito_Logistico_Binario_test$DEATH_EVENT, df_predito_Logistico_Binario_test$preditoTeste)
#cut_log_teste_bal

df_predito_Logistico_Binario_test$preditoTestBinario <- as.factor(if_else(df_predito_Logistico_Binario_test$preditoTeste >0.65,1,0))
